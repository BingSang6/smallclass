...
(function () {
  ...
  const SUBJECTS = {
    math: {
      ...
      units: {
        1: ['第一单元 生活中的数', '第二单元 5以内数加与减', '综合实践 介绍我的教室',
            '第三单元 整理与分类', '第四单元 10以内数加与减', '第五单元 有趣的立体图形', '综合实践 记录我的一天'],
        ...
        4: ['第一单元 认识更大的数', '综合实践 编码', '第二单元 线与角', '第三单元 整数乘法（二）',
            ...
            '第七单元 运用数量关系解决问题', '第八单元 数据的表示和分析（一）'],
    ...
    english: {   // 英语·单词（题源 english-primary-shenzhen-oxford.md 沪教牛津深圳版，公共词表）
      ...
      // v3.11 增补一、二年级：深圳为英语一年级起始地区（沪教牛津深圳版一上/二上各 12 单元）
      unitsBank: 'data/banks/english-units.json',
      units: {
        1: ['第一单元 打招呼', '第二单元 同学与文具', '第三单元 我的五官', '第四单元 我会做',
            '第五单元 我的家人', '第六单元 我的朋友', '第七单元 数一数', '第八单元 买水果',
            '第九单元 买食物', '第十单元 农场动物', '第十一单元 动物园', '第十二单元 公园与颜色'],
        2: ['第一单元 日常问候', '第二单元 自我介绍', '第三单元 你是谁', '第四单元 我会运动',
            '第五单元 我的家庭', '第六单元 外貌特征', '第七单元 游乐场', '第八单元 我的房间',
            '第九单元 晚餐', '第十单元 天空', '第十一单元 森林动物', '第十二单元 爱护花草'],
      ...
      levels: LEVELS, medals: MEDALS,
      levelDesc: {
        1: ['打招呼', '文具五官', '家人朋友', '数字水果', '食物农场', '动物颜色'],
        2: ['问候介绍', '数字运动', '家庭外貌', '游乐场房间', '晚餐天空', '森林综合'],
